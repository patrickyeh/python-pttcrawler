...
class monitor(threading.Thread):
    ...
    def add_receiver(self,obj_receiver):
        self.lst_receiver.append(obj_receiver)

    def get_receiver(self):
        return self.lst_receiver

    def broadcast_list_data(self,lst_data):
        for obj_receiver in self.lst_receiver:
            for obj_data in lst_data:
                obj_receiver.send(obj_data)
    ...
    def run(self):
        ...
        while True:
            ...
            for article_id in lst_new_article_list:
                ...
                obj_new_article.send_article_info()
                obj_new_article.add_receiver(self.obj_reply_receiver)
